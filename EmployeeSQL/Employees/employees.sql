-- USE of NOT NULL: 
-- If the column must always have a value (e.g., primary keys, required fields).
-- If missing values don’t make sense (e.g., emp_no, age, quantity).
-- To improve performance, since NULL values require extra storage.
